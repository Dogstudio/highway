...
<body>
    <main class="site-container">
        ...
        <article class="site-content" data-router-view="get-started">
            ...
            <p>Transitions in <strong>Highway</strong> are pretty simple. A default transition called <strong>Highway.Transition</strong> can be extended to create our custom ones. Once we've extended the <strong>Highway.Transition</strong> we have acces to those essential methods:</p>
            ...
            <p>Each of those methods can get two parameters in this order we can name the way we want be here are some good defaults:</p>
            ...
            <p>Remember the <strong>data-router-view</strong> we added to our view? We named it and the name we gave to the <strong>data-router-view</strong> will be now used to attach it to our custom renderer and transition.</p>
            ...
            <p>We might want to use the same transition for all the views across our website. This is possible by adding a <strong>default</strong> key to our transitions list in the <strong>Highway.Core</strong> options. When you do so, for each view, Highway will look for a transition attached to our <strong>data-router-view</strong> name and fallback to the default one if none is found.</p>
