...
function (_Emitter) {
  ...
  _createClass(Core, [{
    ...
    value: function click(event) {
      ...
      var href = event.currentTarget.href; // We get the anchor and the pathname of the link that the user clicked
    ...
    value: function pushState() {
      // We update the state based on the clicked link `href` property.
      var state = this.getState(this.link.href); // We push a new entry in the history in order to be able to navigate
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 9:
                ...
                this.props = this.getProps(page); // Cache page
