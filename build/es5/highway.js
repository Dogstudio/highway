...
function () {
  ...
  _createClass(Helpers, [{
    ...
    value: function getRenderer(slug) {
      return slug in this.renderers ? this.renderers[slug] : _renderer.default;
    }
    /**
     * Get page transition
     *
...
function (_Emitter) {
  ...
  function Core() {
    ...
    _this.From = new _this.properties.renderer(_this.properties);

    _this.From.setup(); // Events variables.
